				...
				<div id="store">
					...
					?>	
						...
						<div class="row list-annonce">
							<div class="col-md-12">
								<div class="col-md-3">
									<img width="100%" class="img-responsive" src="<?= img_url('assets/img/','img-boutique-1.png'); ?>" alt="">
								</div>
								<div class="col-md-9">
									<h3 class="card-title">Nom Entreprise</h3>
						            ...
						            <div class="row">
						            	<div class="col-md-6">
						            		<span class="text-danger">Contact : 000000000000</span><br>
								            <span class="text-danger">Contact : 000000000000</span><br>
								            <span class="text-danger">Contact : 000000000000</span><br>
								            <span class="text-danger">Contact : 000000000000</span>
						            	</div>
						            	<div class="col-md-6">
						            		<h4 class="product-price">1500 annonces</h4>
								            <div class="product-btns">
												<button class="primary-btn add-to-cart">La boutique</button>
												<button class="primary-btn add-to-cart">Les annonces</button>
											</div>
						            	</div>
						            </div>
