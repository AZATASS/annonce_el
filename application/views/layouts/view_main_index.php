      ...
      <div class="container">
        <div class="pull-left">
          ...
          <div class="header-logo">
            <a class="logo" href="<?= site_url('accueil'); ?>">
        ...
        <div class="pull-right">
          <ul class="header-btns">
            ...
            <li class="header-account dropdown default-dropdown">
              ...
              <a href="<?= site_url('accueil','login_annonceur'); ?>" class="text-uppercase">S'identifier</a>
              <ul class="custom-menu">
                <li><a href="#"><i class="fa fa-exchange"></i> Publier une annonce</a></li>
                <li><a href="#"><i class="fa fa-heart-o"></i> Mes favoris</a></li>
                <li><a href="<?= site_url('accueil','creer_cpt_annonceur'); ?>"><i class="fa fa-user-plus"></i> Créer un compte</a></li>
                <li><a href="#"><i class="fa fa-check"></i> Mot de passe oublier</a></li>
              </ul>
            </li>
            <!-- /Account -->
      ...
      <div id="responsive-nav">
        ...
        <div class="menu-nav">
          ...
          <ul class="menu-list">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="hidden-sm hidden-xs">
                      <a class="banner banner-1" href="<?= site_url('accueil'); ?>">
                        <img src="<?= img_url('assets/img/','logo.png'); ?>" alt="">
                    ...
                    <ul class="list-links">
                      <li>
                        <h3 class="list-links-title text-center"><a href="<?= site_url('accueil'); ?>">Page 1</a></h3>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4">
                    ...
                    <ul class="list-links">
                      <li>
                        <h3 class="list-links-title text-center"><a href="<?= site_url('accueil'); ?>">Page 2</a></h3>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4">
                    ...
                    <ul class="list-links">
                      <li>
                        <h3 class="list-links-title text-center"><a href="<?= site_url('accueil'); ?>">Page 3</a></h3>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <li><a href="<?= site_url('accueil','all_annonces'); ?>">Toutes les annonces</a></li>
            <li><a href="<?= site_url('accueil','boutiques'); ?>">La boutique</a></li>
            <li><a href="<?= site_url('accueil','contactez_nous'); ?>">Contactez-nous</a></li>
          </ul>
        </div>
        <!-- menu nav -->
      </div>
